 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_1[TASK_1_STACK_SIZE];	/* Task 1 (tsk_json_parser) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 1))
    #define TASK_2_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_2[TASK_2_STACK_SIZE];	/* Task 2 (tsk_hmi) */
    #endif
    ...
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_init) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        {0}
        #ifdef TASK_1_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_1[(TASK_1_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_json_parser*/
        #endif
        #ifdef TASK_2_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_2[(TASK_2_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_hmi*/
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_background*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_init*/
        #endif
        #ifdef TASK_5_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #if EE_MAX_TASK > 0
        &EE_oo_thread_stub       /* thread tsk_json_parser */
    #endif
    #if EE_MAX_TASK > 1

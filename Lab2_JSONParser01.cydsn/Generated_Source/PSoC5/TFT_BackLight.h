...
***************************************/
#define TFT_BackLight_Resolution                     (16u)
...
#if (!TFT_BackLight_UsingFixedFunction)
    uint16   TFT_BackLight_ReadCounter(void) ;
    uint16 TFT_BackLight_ReadCapture(void) ;

    #if (TFT_BackLight_UseStatus)
            void TFT_BackLight_ClearFIFO(void) ;
    #endif /* (TFT_BackLight_UseStatus) */

    void    TFT_BackLight_WriteCounter(uint16 counter)
            ;
#endif /* (!TFT_BackLight_UsingFixedFunction) */

void    TFT_BackLight_WritePeriod(uint16 period)
        ;
uint16 TFT_BackLight_ReadPeriod(void) ;

#if (TFT_BackLight_UseOneCompareMode)
    void    TFT_BackLight_WriteCompare(uint16 compare)
            ;
    uint16 TFT_BackLight_ReadCompare(void) ;
#else
    void    TFT_BackLight_WriteCompare1(uint16 compare)
            ;
    uint16 TFT_BackLight_ReadCompare1(void) ;
    void    TFT_BackLight_WriteCompare2(uint16 compare)
            ;
    uint16 TFT_BackLight_ReadCompare2(void) ;
#endif /* (TFT_BackLight_UseOneCompareMode) */
...
******************************** */
   ...
   #define TFT_BackLight_RT1_PTR                 ( (reg8 *)  TFT_BackLight_PWMHW__RT1)
       ...
       #if(TFT_BackLight_PWMModeIsCenterAligned)
           #define TFT_BackLight_PERIOD_LSB      (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
           #define TFT_BackLight_PERIOD_LSB_PTR  ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #else
           #define TFT_BackLight_PERIOD_LSB      (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F0_REG)
           #define TFT_BackLight_PERIOD_LSB_PTR  ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F0_REG)
       #endif /* (TFT_BackLight_PWMModeIsCenterAligned) */

       #define TFT_BackLight_COMPARE1_LSB        (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D0_REG)
       #define TFT_BackLight_COMPARE1_LSB_PTR    ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D0_REG)
       #define TFT_BackLight_COMPARE2_LSB        (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #define TFT_BackLight_COMPARE2_LSB_PTR    ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
       #define TFT_BackLight_COUNTERCAP_LSB      (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A1_REG)
       #define TFT_BackLight_COUNTERCAP_LSB_PTR  ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A1_REG)
       #define TFT_BackLight_COUNTER_LSB         (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A0_REG)
       #define TFT_BackLight_COUNTER_LSB_PTR     ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A0_REG)
       #define TFT_BackLight_CAPTURE_LSB         (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F1_REG)
       #define TFT_BackLight_CAPTURE_LSB_PTR     ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(TFT_BackLight_PWMModeIsCenterAligned)
               #define TFT_BackLight_PERIOD_LSB      (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
               #define TFT_BackLight_PERIOD_LSB_PTR  ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
            #else
               #define TFT_BackLight_PERIOD_LSB      (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F0_REG)
               #define TFT_BackLight_PERIOD_LSB_PTR  ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F0_REG)
            #endif /* (TFT_BackLight_PWMModeIsCenterAligned) */

            #define TFT_BackLight_COMPARE1_LSB       (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D0_REG)
            #define TFT_BackLight_COMPARE1_LSB_PTR   ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D0_REG)
            #define TFT_BackLight_COMPARE2_LSB       (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
            #define TFT_BackLight_COMPARE2_LSB_PTR   ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__D1_REG)
            #define TFT_BackLight_COUNTERCAP_LSB     (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A1_REG)
            #define TFT_BackLight_COUNTERCAP_LSB_PTR ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A1_REG)
            #define TFT_BackLight_COUNTER_LSB        (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A0_REG)
            #define TFT_BackLight_COUNTER_LSB_PTR    ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A0_REG)
            #define TFT_BackLight_CAPTURE_LSB        (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F1_REG)
            #define TFT_BackLight_CAPTURE_LSB_PTR    ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__F1_REG)
        #else
            #if(TFT_BackLight_PWMModeIsCenterAligned)
               #define TFT_BackLight_PERIOD_LSB      (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
               #define TFT_BackLight_PERIOD_LSB_PTR  ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #else
               #define TFT_BackLight_PERIOD_LSB      (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG)
               #define TFT_BackLight_PERIOD_LSB_PTR  ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG)
            #endif /* (TFT_BackLight_PWMModeIsCenterAligned) */

            #define TFT_BackLight_COMPARE1_LSB       (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG)
            #define TFT_BackLight_COMPARE1_LSB_PTR   ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG)
            #define TFT_BackLight_COMPARE2_LSB       (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #define TFT_BackLight_COMPARE2_LSB_PTR   ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG)
            #define TFT_BackLight_COUNTERCAP_LSB     (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG)
            #define TFT_BackLight_COUNTERCAP_LSB_PTR ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG)
            #define TFT_BackLight_COUNTER_LSB        (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG)
            #define TFT_BackLight_COUNTER_LSB_PTR    ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG)
            #define TFT_BackLight_CAPTURE_LSB        (*(reg16 *) TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG)
            #define TFT_BackLight_CAPTURE_LSB_PTR    ((reg16 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define TFT_BackLight_AUX_CONTROLDP1          (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u1__DP_AUX_CTL_REG)
       #define TFT_BackLight_AUX_CONTROLDP1_PTR      ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (TFT_BackLight_Resolution == 8) */

   #define TFT_BackLight_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__A1_REG)
   #define TFT_BackLight_AUX_CONTROLDP0          (*(reg8 *)  TFT_BackLight_PWMUDB_sP16_pwmdp_u0__DP_AUX_CTL_REG)
   #define TFT_BackLight_AUX_CONTROLDP0_PTR      ((reg8 *)   TFT_BackLight_PWMUDB_sP16_pwmdp_u0__DP_AUX_CTL_REG)
